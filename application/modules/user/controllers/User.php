...
class User extends CI_Controller {
    ...
    /**
     * This function is used to create datatable in schedule list page
     * @return Void
     */
    ...
    /**
     * This function is Showing schedule
     * @return Void
     */
    public function schedule($id='') {   
        ...
        // }
        // if($this->session->userdata('user_details')[0]->user_type == 'teacher'){
        //     $data['schedule_data'] = $this->User_model->get_data_by('class_time_subject', $id, 'teacher_id');
        // }
        
        $this->load->view('include/header'); 
        $this->load->view('schedule_table');
        $this->load->view('include/footer');
    }
