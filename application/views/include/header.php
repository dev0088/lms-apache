          ...
          <header class="main-header">
            <a href="<?php echo base_url(); ?>" class="logo">
             <?php $logo =  (setting_all('logo'))?setting_all('logo'):'logo.png'; ?>
              ...
              <span class="logo-mini"><img src="<?php echo base_url().'assets/images/'.$logo; ?>" id="logo" style="width:50px; height:50px;"></span>
              <!-- logo for regular state and mobile devices -->
              <span class="logo-lg"><img src="<?php echo base_url().'assets/images/'.$logo; ?>" id="logo" style="width:50px; height:50px;"></span>
            </a>
          ...
          <aside class="main-sidebar">
            ...
            <section class="sidebar">
              ...
              <ul class="sidebar-menu">
                ...
                <li class="<?=($this->router->method==="schedule")?"active":"not-active"?>"> 
                  <a href="<?php echo base_url('user/schedule');?>"> <i class="fa fa-user"></i> <span>Schedule</span></a>
                </li>
