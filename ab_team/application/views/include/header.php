    ...
    <body class="hold-transition skin-black-light sidebar-mini" data-base-url="<?php echo base_url(); ?>">
        <div class="wrapper">
          ...
          <header class="main-header">
            <a href="<?php echo base_url(); ?>" class="logo" style="background: white;">
             <?php $logo =  (setting_all('logo'))?setting_all('logo'):'logo.png'; ?>
              ...
              <span class="logo-lg"><img src="<?php echo base_url().'assets/images/'.$logo; ?>" id="logo" style="height: 50px; width: auto;"></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                          ...
                          <ul class="dropdown-menu" role="menu" style="width: 164px;">
                              <li><a href="<?php echo base_url('user/profile');?>"><i class="fa fa-user mr10" style="width: 15px; height: 14px; text-align: center;"></i> <span>Profile</span></a></li>
            ...
            <section class="sidebar">
              ...
              <ul class="sidebar-menu">
                <li class="header"><!-- MAIN NAVIGATION --></li>
                  ...
                  <li class="<?=($this->router->class==="gp")?"active":"not-active"?>">
                      <a href="<?php echo base_url("mallar");?>"><i class="fa fa-table"></i> <span>Mallar</span></a>
                  </li>
